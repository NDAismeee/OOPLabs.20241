...
import hust.soict.dsai.aims.screen.AddTrackScreenController;
...
public class AddTrack extends JFrame{
    ...
    public AddTrack(CompactDisc CD) {
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/hust/soict/dsai/aims/screen/addTracks.fxml"));
